...
`decision-os-min` has completed Stage 1 and now contains a deliberately narrow
**Stage 1.5 hosted/isolation experiment**. The
...
| **1.5 — Hosted enforcement boundary** | Intent-only Host plane + qualified Linux/Docker isolation slices | ✅ **evidenced here**; TM-A full remains PARTIAL |
| **2 — Agent Runtime** | durable sessions, lifecycle supervision, scheduling, broad resource governance | 🔬 partial experiments only; separate track |
...
Stages 2–5 remain substantial work. They belong in a **separate
...
## What comes before expanding Stage 2
